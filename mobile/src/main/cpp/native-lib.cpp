...
#define alog(...) __android_log_print(ANDROID_LOG_ERROR, "HealthTracker", __VA_ARGS__);
...
extern "C"
void
Java_com_example_jerry_HealthTracker_initCaffe2(
        JNIEnv* env,
        jobject /* this */,
...
Java_com_example_jerry_HealthTracker_classificationFromCaffe2(
        JNIEnv *env,
        jobject /* this */,
